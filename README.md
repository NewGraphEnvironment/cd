...
cd computes climate anomalies from [ERA5-Land](https://www.ecmwf.int/en/era5-land) reanalysis data for custom areas of interest. It downloads raw climate data, derives variables (VPD, RH, soil moisture), publishes Cloud-Optimized GeoTIFFs to a STAC catalog, and provides consumer functions to extract zonal statistics, compute baselines and anomalies for arbitrary reference periods, and run trend analysis.
