...
ERA5-Land overestimates SWE in mountain terrain by 150-200%
[@kouki_etal2023Evaluationsnow], so the absolute values below are biased
high; the bias is approximately stable over time, so the trends are
still defensible. The trend tests below use raw Mann-Kendall plus
Theil-Sen — no pre-whitening — which is the methodologically correct
choice for our 76-year series with strong climate trends per Yue and
Wang [-@yue_wang2002Applicabilityprewhitening] (pre-whitening
